...
class MutateDB_WebappSreenProductEditShoppingCart extends MutateDB {
        ...
        if (this._connectionPool !== undefined && this._order !== undefined) {
            try {
                const result = await this._connectionPool
                    ...
                    .input("id", sql.Int, this._order.id)
                    .input("userId", sql.Int, this._order.userId)
                    .execute('WebappSreenProductEditShoppingCart');
...
export default MutateDB_WebappSreenProductEditShoppingCart;
