...
import { PagedOrderField, OrderField, AdminOrderBodyType } from '@src/dataStruct/order';
import QueryDB_WebadminSreenOrderGetOrders from '../../queryDB/WebadminSreenOrderGetOrders';
...
class Handle_WebadminSreenOrderGetOrders {
    private _mssql_server = mssql_server;

    constructor() {}

    main = async (req: Request<Record<string, never>, unknown, AdminOrderBodyType>, res: Response) => {
        ...
        const queryDB_webappSreenMyOrderGetMyOrders = new QueryDB_WebadminSreenOrderGetOrders();
        queryDB_webappSreenMyOrderGetMyOrders.setOrderBody(orderBody);
...
export default Handle_WebadminSreenOrderGetOrders;
